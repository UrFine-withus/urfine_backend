...
const { getAllCheckupRequestData,createCheckupRequestData,deleteCheckupRequestData,getAcceptedCheckupRequestData,acceptCheckupRequestData,CheckupRequestCountData,createCheckupResultData,updateCheckupResultData,getAllCheckupResultData,getUpcomingAcceptedCheckupRequestData} = require('../controllers/checkup.controller');
...
router.route('/accepted/date').get(getUpcomingAcceptedCheckupRequestData);
